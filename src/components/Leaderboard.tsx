...
const Leaderboard: React.FC = () => {
  ...
  return (
    <div className="bg-gray-800 border-4 border-neonYel/80 rounded-lg p-4 w-full shadow-lg">
      <div className="flex items-center justify-center mb-2 bg-neonYel/80 py-1 rounded-t-sm">
        <Trophy className="text-neonYel/80 mr-2" size={20} />
          ...
          {topEntries.map((entry, index) => (
            <div 
              ...
              className={`
                ...
                ${index === 0 ? 'bg-neonYel/80' : index === 1 ? 'bg-gray-400' : 'bg-amber-700'}
