  ...
  return (
    <div className="min-h-screen bg-bezel text-neonYel font-arcade
      ...
      <div className="flex gap-14 flex-wrap justify-center items-start">
        ...
        <div className="flex flex-col items-center w-[30rem] gap-4 pt-6">
          {activeFighter ? (
            <>
              <img
              ...
              {/* full quip – wide container, wraps if truly needed */}
              <p className="italic text-center text-base leading-snug">
                {activeFighter.quip}
              </p>
            ...
            <div
              className="w-full h-[17rem] flex flex-col items-center justify-center
