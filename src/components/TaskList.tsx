...
const TaskList: React.FC = () => {
  ...
  return (
    <div className="bg-gray-800 border-4 border-gray-600 p-4 rounded-lg shadow-lg max-h-[400px] w-full overflow-hidden flex flex-col">
      <h2 className="text-white font-bold text-xl mb-3 bg-crtBlue p-2 text-center border-2 border-crtBlue/80">
        MISSION TASKS
      </h2>
            ...
            {tasks.map((task) => (
              <li 
                ...
                className={`
                  ...
                  border-l-4 ${task.completed ? 'border-green-500' : 'border-neonYel'}
                `}
              >
                ...
                <div className="flex space-x-1">
                  <button
                    ...
                    className={`
                      p-1 rounded 
                      ${task.completed ? 'bg-crtBlue hover:bg-crtBlue/80' : 'bg-green-600 hover:bg-green-700'}
                      text-white
                    `}
                  >
                    <Check size={16} />
                  ...
                  <button
                    ...
                    className="p-1 rounded bg-neonRed hover:bg-neonRed/80 text-white"
                  >
                    <Trash2 size={16} />
                  </button>
                </div>
