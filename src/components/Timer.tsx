  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className={`
        ...
        ${mode === 'work' ? 'bg-neonRed text-white border-neonRed/80' : 'bg-crtBlue text-white border-crtBlue/80'}
      `}>
      ...
      <div className={`
        ...
        ${mode === 'work' ? 'border-neonRed' : 'border-crtBlue'}
      `}>
        {formatTime(timeLeft)}
      ...
      <div className="flex space-x-4 mt-4">
        ...
        <button
          ...
          className={`
            ...
            ${isRunning ? 'bg-neonYel hover:bg-neonYel/80' : 'bg-green-500 hover:bg-green-600'}
            text-white rounded-lg border-b-4 border-r-4
            ${isRunning ? 'border-neonYel/80' : 'border-green-700'}
        ...
        <button
          ...
          className="
            w-16 h-16 flex items-center justify-center
            bg-neonRed hover:bg-neonRed/80 text-white rounded-lg
            border-b-4 border-r-4 border-neonRed/80
            transform active:translate-y-1 active:translate-x-1 active:border-b-0 active:border-r-0
            transition-all duration-100
          "
        >
        ...
        <button
          ...
          className="
            w-16 h-16 flex items-center justify-center
            bg-crtBlue hover:bg-crtBlue/80 text-white rounded-lg
            border-b-4 border-r-4 border-crtBlue/80
            transform active:translate-y-1 active:translate-x-1 active:border-b-0 active:border-r-0
            transition-all duration-100
          "
        >
